...
@section('container')
@php
$selectedMaterials = old('raw_material_id', $product->rawMaterials->pluck('id')->toArray());
@endphp
                            ...
                            <div class="col-md-12">
                                <div class="profile-img-edit">
                                    <div class="crm-profile-img-edit">
                                        <img class="crm-profile-pic rounded-circle avatar-100" id="image-preview" src="{{ $product->product_image ? asset('assets/images/product/'.$product->product_image) : asset('assets/images/product/default.webp') }}" alt="profile-pic">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=" row align-items-center">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select class="form-control select-multiple" name="raw_material_id[]" multiple>
                                    ...
                                    <option value="{{ $rawMaterial->id }}" {{ in_array($rawMaterial->id, $selectedMaterials) ? 'selected' : '' }}>{{ $rawMaterial->name }}</option>
                                    @endforeach
                                </select>
